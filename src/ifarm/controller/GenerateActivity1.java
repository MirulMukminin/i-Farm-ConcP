...
public final class GenerateActivity1 {
...
private JSONObject farmObj;
    ...
    public GenerateActivity1(){
        //generateRand();
    } 
    
    public GenerateActivity1(List<String> farms, JSONObject farmObj, JSONArray plantArr, JSONArray fertArr, JSONArray pestArr){
        this.userFarms = farms;
        this.farmObj = farmObj;
        generateRand(plantArr, fertArr, pestArr);
    } 
    
    public void generateRand(JSONArray plantArr,JSONArray fertArr, JSONArray pestArr){
